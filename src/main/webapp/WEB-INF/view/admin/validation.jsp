					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="card-box">
								...
								<p class="text-muted font-14 m-b-20">Parsley is a javascript
								...
								<form action="#">
									...
									<div class="form-group">
										<label for="emailAddress">Email address<span
											...
											parsley-trigger="change" required placeholder="Enter email"
									...
									<div class="form-group">
										<div class="checkbox checkbox-purple">
											<input id="checkbox6a" type="checkbox"> <label
												for="checkbox6a"> Remember me </label>
										</div>
									...
									<div class="form-group text-right m-b-0">
										...
										<button type="reset"
											class="btn btn-secondary waves-effect m-l-5">Cancel
										</button>
									</div>
						...
						<div class="col-lg-6">
							<div class="card-box">
								...
								<form role="form">
									...
									<div class="form-group row">
										<label for="hori-pass2" class="col-4 col-form-label">Confirm
									...
									<div class="form-group row">
										<label for="webSite" class="col-4 col-form-label">Web
										...
										<div class="col-8 offset-4">
											<div class="checkbox checkbox-purple">
												<input id="checkbox6" type="checkbox"> <label
													for="checkbox6"> Remember me </label>
											</div>
										</div>
									</div>
									<div class="form-group row">
