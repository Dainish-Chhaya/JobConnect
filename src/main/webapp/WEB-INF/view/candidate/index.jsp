                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title float-left">Candidate Dashboard</h4>
                        ...
                        <div class="card-box homePage m-3 mainDiv">
                            ...
                            <div class="companyText">
                                ...
                                <p class="paragraph">
                                    ...
                                    Explore tailored job listings across diverse industries, from technology to
                                    healthcare.
                                    Apply effortlessly, track applications, and stay informed every step of the way.
                                    Take control of your career journey with a user-friendly, secure platform.
                                </p>
                            </div>
                        </div>
                    </div>
