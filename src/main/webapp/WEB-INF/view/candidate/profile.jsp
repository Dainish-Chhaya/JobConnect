    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title float-left">Candidate Profile</h4>
                ...
                <!-- Form to display and edit recruiter information -->
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <h4 class="header-title">Candidate Information</h4>
                            <hr/>
                            <!-- Recruiter info form -->
                            <f:form modelAttribute="candidate" method="post" action="saveProfile"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" aria-disabled="true">
                                            ...
                                            <f:input path="email" placeholder="Email Address" class="form-control"
                                                     readonly="true" parsley-trigger="change" required="required"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <f:input path="collegeName" placeholder="College Name" class="form-control"
                                                     required="required"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <f:input path="degree" placeholder="Degree" class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <f:input path="skills" placeholder="Skills" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
